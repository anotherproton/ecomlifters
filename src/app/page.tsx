...
export default function Home() {
  ...
  return (
    <main>
      <SeoData
        title="EcomLifters - E-commerce Growth Agency"
        description="EcomLifters helps businesses grow through expert e-commerce solutions, digital marketing, and Shopify development."
      />
      <RefreshGsap />
      <BrandingHero {...hero} />
