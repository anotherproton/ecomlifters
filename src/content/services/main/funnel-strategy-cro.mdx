...
description: "We build conversion-focused funnels using landing pages, heatmap tracking, and A/B testing — so every click brings you closer to a sale."
contactTitle: "Start your experience with Arolax"
btn_text: "Let's get in touch"
features:
  - "Landing Page Design & Copy"
  - "Lead Magnet & Email Sequence Planning"
  - "Heatmap & Behavior Analysis"
  - "Funnel Flow Mapping"
  - "A/B Testing & Performance Uplifts"
